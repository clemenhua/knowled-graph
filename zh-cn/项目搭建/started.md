...
![1603853394460](started.assets/1603853394460.png)
...
> 目的：Vuex 是一个专为 Vue.js 应用程序开发的**状态管理模式 + 库**。它采用集中式存储管理应用的所有组件的状态，并以相应的规则保证状态以一种可预测的方式发生变化。
...
![1605599713484](started.assets/1605599713484.png)
